# footbibx - an update of footbib style tolerant to LaTeX output routine updates
...
В связи с этим мной в пакет footbib.sty сначала были внесены исправления, учитывающие изменения ядрв LaTeX на дату 2022/11/11 (версия 2.0.8). Однако, такого рода изменения могли привести к тому, что с изменением в будущем ядра LaTeX эта версия `footbib.sty` также перестала бы работать.
